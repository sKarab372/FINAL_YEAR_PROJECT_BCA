...
const API       = "https://quantdesk-api.onrender.com/api";
const ML_API    = "https://quantdesk-ml.onrender.com/api";
const AGENT_API = "https://quantdesk-agent.onrender.com/agent";
